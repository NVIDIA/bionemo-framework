...
class PerTokenValueDataModule(pl.LightningDataModule):
    def __init__(
        self,
        train_data: Sequence[Tuple[str, str, str]],
        valid_data: Sequence[Tuple[str, str, str]],
        seed: int | None = 42,
