...
def test_load_data_run_benchmark(celltype_bench_data):
    # Loads embeddings, h5ad file, scdl files, and CV results.
    contents_dir = celltype_bench_data
...
def test_celltype_embeddings_golden_values(celltype_bench_data, geneformer_10m_checkpoint):
    ...
    checkpoint_path = geneformer_10m_checkpoint
