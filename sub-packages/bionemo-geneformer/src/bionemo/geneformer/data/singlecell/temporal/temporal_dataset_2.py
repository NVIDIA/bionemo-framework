...
class TemporalDatasetNew(Dataset):
    ...
    def __init__(  # noqa: D107
        ...
        logging.info(f"[TemporalDatasetNew] only_cells_with_neighbors={self.only_cells_with_neighbors}")
        print(f"[TemporalDatasetNew] only_cells_with_neighbors={self.only_cells_with_neighbors}")
