...
@pytest.mark.parametrize("model_size", ["7b_nv", 
                                        pytest.param("7b_arc_longcontext", marks=pytest.mark.xfail(reason="Might fail on certain types of GPU. https://github.com/NVIDIA/bionemo-framework/issues/731"))
                                       ])
