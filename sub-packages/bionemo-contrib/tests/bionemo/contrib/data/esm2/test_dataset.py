...
from bionemo.contrib.data.esm2.dataset import (
    ESMMaskedResidueDataset,
    ProteinSQLiteDataset,
    create_train_dataset,
    create_valid_dataset,
)
from bionemo.contrib.data.esm2.tokenizer import SpecialToken
...
def test_ESMPreTrainingDataset_getitem_has_expected_structure(dummy_protein_dataset):
    ...
    assert sample["text"][0] == SpecialToken.CLS
    assert sample["text"][-1] == SpecialToken.EOS
