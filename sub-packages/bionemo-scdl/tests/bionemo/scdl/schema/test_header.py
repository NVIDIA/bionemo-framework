...
from bionemo.scdl.schema.headerutil import HeaderSerializationError, Endianness
from bionemo.scdl.schema.version import SCDLVersion, CurrentSCDLVersion
...
class TestFeatureIndexInfo:
    ...
    def test_validation_empty_file_path(self):
        ...
        feature_index = FeatureIndexInfo(
            ...
            length=100,
            dtype=ArrayDType.UINT8_ARRAY,
            index_files=["valid.dat", "", "another.dat"]
        )
