        ...
        if lt.shape != rt.shape:
            ...
            if (
                ...
                rt = unshard_row_parallel_state(
                    rt, out_features=left_shape[-2], in_features=left_shape[-1], tp=rt.shape[-2]
                )
            else:
                try:
