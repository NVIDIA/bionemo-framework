...
CHECKPOINTS=(
    # "ft_checkpoints/evo2_7b_1m_100_ncbi_virus_train_set_ecoli_full_species/evo2/checkpoints/epoch=0-step=99-consumed_samples=800.0-last"
    # "ft_checkpoints/evo2_7b_1m_200_ncbi_virus_train_set_ecoli_full_species/evo2/checkpoints/epoch=0-step=199-consumed_samples=1600.0-last"
    # "ft_checkpoints/evo2_7b_1m_500_ncbi_virus_train_set_ecoli_full_species/evo2/checkpoints/epoch=0-step=499-consumed_samples=4000.0-last"
    # "ft_checkpoints/evo2_7b_1m_1000_ncbi_virus_train_set_ecoli_full_species/evo2/checkpoints/epoch=0-step=999-consumed_samples=8000.0-last"
    "ft_checkpoints/evo2_7b_1m_2000_ncbi_virus_train_set_ecoli_full_species/evo2/checkpoints/epoch=0-step=1999-consumed_samples=16000.0-last"
