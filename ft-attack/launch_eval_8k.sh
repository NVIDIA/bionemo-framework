...
for fasta_dir in ncbi_downloads_sequences_train_40 ncbi_downloads_sequences_test_60
do
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python eval_ppl.py \
 --fasta /workspaces/bionemo-framework/ft-attack/data/${fasta_dir}/merged.fna \
 --ckpt-dir /workspaces/bionemo-framework/ft-attack/checkpoints/evo2_7b_8k_${max_steps}/evo2/checkpoints/epoch=0-step=$((max_steps-1))-consumed_samples=$consumed_samples.0-last  \
 --batch-size $((tensor_parallel_size * 2)) \
 --model-size 7b \
 --tensor-parallel-size $tensor_parallel_size \
 --output-dir /workspaces/bionemo-framework/ft-attack/figures/${fasta_dir}/ \
