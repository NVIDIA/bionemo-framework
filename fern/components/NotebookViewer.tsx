 ...
 * Generate data with `fern/scripts/ipynb-to-fern-json.py` from `.ipynb` files.
 *
 ...
 *   <NotebookViewer
 *     notebook={notebook}
 *     colabUrl="https://colab.research.google.com/github/NVIDIA/bionemo-framework/blob/main/path/to/notebook.ipynb"
 *   />
 */
  ...
  if (notebook == null || typeof notebook !== "object") {
    return (
      <NotebookViewerError
        ...
        detail={`Received: ${typeof notebook}. Run python fern/scripts/ipynb-to-fern-json.py on your .ipynb and import the generated .ts module.`}
      />
    );
  }
