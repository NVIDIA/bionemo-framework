...
Dataset](/main/datasets/uniprot)). This validation set was used to ensure that the output of BioNeMo-converted
...
<Note>Different Validation Sets</Note>
