---
title: "Access and Startup BioNeMo Framework"
description: ""
---
...
Refer to the next section, [Initialization Guide](/main/getting-started/initialization-guide), for useful `docker run` command
