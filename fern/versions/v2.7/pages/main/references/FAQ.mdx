...
hardware, refer to the [Hardware and Software Prerequisites](/main/getting-started/pre-reqs).
...
For more information about external contributions, refer to the [Contributing Guidelines](/main/contributing/contributing) and
[Code Review](/main/contributing/code-review) pages.
