...
- [AMPLIFY](/main/recipes/models/amplify) -- protein representation learning
- [ESM-2](/main/recipes/models/esm2) -- protein representation learning
- [Geneformer](/main/recipes/models/geneformer) -- single-cell gene expression
- [Llama 3](/main/recipes/models/llama3) -- general-purpose language model
- [Mixtral](/main/recipes/models/mixtral) -- mixture-of-experts language model
- [Qwen](/main/recipes/models/qwen) -- general-purpose language model

### Training Recipes

Complete training environments with scripts, configs, and sample data:

- [esm2_native_te](/main/recipes/recipes/esm2_native_te) -- ESM-2 pretraining with native FSDP + TransformerEngine
- [esm2_accelerate_te](/main/recipes/recipes/esm2_accelerate_te) -- ESM-2 pretraining with HF Accelerate + TransformerEngine
- [esm2_peft_te](/main/recipes/recipes/esm2_peft_te) -- ESM-2 parameter-efficient fine-tuning
- [geneformer_native_te_mfsdp_fp8](/main/recipes/recipes/geneformer_native_te_mfsdp_fp8) -- Geneformer pretraining with FP8
- [llama3_native_te](/main/recipes/recipes/llama3_native_te) -- Llama 3 pretraining with native FSDP
- [fp8_analysis](/main/recipes/recipes/fp8_analysis) -- FP8 precision analysis tools
- [vit](/main/recipes/recipes/vit) -- Vision Transformer reference recipe
...
- [evo2_megatron](/main/recipes/recipes/evo2_megatron) -- Evo2 DNA model with Megatron-Bridge based training for 5D parallelism support
- [eden_megatron](/main/recipes/recipes/eden_megatron) -- Eden DNA model with Megatron-Bridge based training for 5D parallelism support

## [BioNeMo Sub-packages](/main/developer-guide/SUMMARY)

Lightweight, pip-installable Python packages that provide reusable building blocks for training and data processing:

- [bionemo-core](/main/developer-guide/bionemo-core/bionemo-core-Overview) -- shared interfaces, data-loading helpers, and checkpoint management
- [bionemo-moco](/main/developer-guide/bionemo-moco/bionemo-moco-Overview) -- modular components for building diffusion and flow-matching generative models
- [bionemo-noodles](/main/developer-guide/bionemo-noodles/bionemo-noodles-Overview) -- fast FASTA/FASTQ parsing via a Python wrapper around the Rust [noodles](https://github.com/zaeleus/noodles) library
- [bionemo-scdl](/main/developer-guide/bionemo-scdl/bionemo-scdl-Overview) -- dataset classes optimized for single-cell data
- [bionemo-size-aware-batching](/main/developer-guide/bionemo-size-aware-batching/bionemo-size-aware-batching-Overview) -- memory-aware mini-batch construction for variable-length inputs
- [bionemo-webdatamodule](/main/developer-guide/bionemo-webdatamodule/bionemo-webdatamodule-Overview) -- a PyTorch Lightning DataModule for streaming WebDataset files
