---
title: "Writing Megatron-LM Compatible Datamodules"
description: ""
---
[Megatron-LM](https://github.com/NVIDIA/Megatron-LM) relies on determinism in the training dataset classes to ensure
that input tensors are initialized correctly across model-parallel ranks (see [NeMo2 Parallelism](/main/about/background/nemo2)). As a
...
<Warning>Avoid `torch.manual_seed`</Warning>
