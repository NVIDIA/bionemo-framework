...
# FIXME convert this to the new megatron bridge style of data modules.
# from nemo.collections.llm.gpt.data import MockDataModule, PreTrainingDataModule
# FIXME where are these now?
# from nemo.collections.llm.recipes.tp_overlap_configs.userbuffers import (
#     userbuffers_bf16_h100_h8192_tp4_mbs1_seqlen8192,
#     userbuffers_fp8_h100_h8192_tp4_mbs1_seqlen8192,
# )
# FIXME tokenizer should be automodel HF tokenizer.
...
# FIXME duplicate training script, probably delete this one.
# def parse_args():
