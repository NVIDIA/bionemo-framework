...
Implements a HuggingFace-compatible Llama model using TE's fused TransformerLayer
for efficient pre-training. Supports:
...
- THD and BSHD attention input formats
"""
