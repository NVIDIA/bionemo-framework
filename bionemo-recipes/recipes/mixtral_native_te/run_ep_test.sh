...
# Example: ./run_ep_test.sh test_8x1B_lingua_ep2
set -e

CONFIG=${1:-test_8x1B_lingua_ep2}

export WANDB_API_KEY=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
