...
Usage:
    ...
    python roofline_prequantized_with_shapes.py --output gemm_benchmark_expected_shapes.png --num-warmup 100 --num-iters 100 --gpu-warmup 100 --shapes 8192x5120x20480,8192x20480x5120
"""
