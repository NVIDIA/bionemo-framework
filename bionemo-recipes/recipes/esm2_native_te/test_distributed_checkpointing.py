...
def test_checkpoint_save_and_load_single_process_mfsdp():
    ...
    try:
        ...
        checkpoint_dirs = [f for f in os.listdir(ckpt_subdir) if f.startswith("step_") and os.path.isdir(os.path.join(ckpt_subdir, f))]
        ...
        # Verify phase 2 completed and created additional checkpoints
        final_checkpoint_dirs = [f for f in os.listdir(ckpt_subdir) if f.startswith("step_") and os.path.isdir(os.path.join(ckpt_subdir, f))]
