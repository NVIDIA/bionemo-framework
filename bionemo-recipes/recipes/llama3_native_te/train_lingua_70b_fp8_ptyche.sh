...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua70b.fp8
...
export EXP_NAME="${EXP_NAME:-lingua_70b_mxfp8_fl1_cp2_8n_ptyche}"
...
echo "========================================="
echo "Starting Lingua 70B MXFP8 FL1 CP=2 Training (8 nodes, ptyche)"
