...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-mp.70b-mxfp8-qi
...
# ============================================================================
# Memory Profiler: Lingua 70B MXFP8 THD qinit (preserve_high_precision_init_val=false)
...
export EXP_NAME="${EXP_NAME:-mp_70b_mxfp8_qinit_3step}"
RESULTS_DIR="${SCRATCH}/results/${EXP_NAME}"
CKPT_ROOT="${SCRATCH}/checkpoints/${EXP_NAME}"
SNAP_DIR="${SCRATCH}/memory_snapshots/70b_mxfp8_qinit_3step"
...
echo "========================================="
echo "Memory Profiler: 70B MXFP8 THD qinit (no HPIV) — MBS=1 (1 node, bia B300)"
