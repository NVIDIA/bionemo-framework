...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-mp.8b-mxfp8-qi-hpiv
...
# ============================================================================
# Memory Profiler: Lingua 8B MXFP8 qinit (preserve_high_precision_init_val=true)
...
export EXP_NAME="${EXP_NAME:-mp_8b_mxfp8_qinit_hpiv_3step}"
RESULTS_DIR="${SCRATCH}/results/${EXP_NAME}"
CKPT_ROOT="${SCRATCH}/checkpoints/${EXP_NAME}"
SNAP_DIR="${SCRATCH}/memory_snapshots/8b_mxfp8_qinit_hpiv_3step"
...
echo "========================================="
echo "Memory Profiler: 8B MXFP8 qinit (HPIV=true) — MBS=4 (1 node, bia B300)"
