...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.mxfp8-nohpiv-mbs5
...
# ============================================================================
# Lingua 7B MXFP8 quantized init — MBS=5 benchmark (1 node, bia B300)
# preserve_high_precision_init_val=false to save memory during init.
# Tests whether disabling HPIV allows MBS=5 to fit.
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-lingua_7b_mxfp8_qinit_no_hpiv_mbs5_1n_bia}"
...
echo "========================================="
echo "Lingua 7B MXFP8 Quantized Init (no HPIV) — MBS=5 Benchmark (1 node, bia B300)"
