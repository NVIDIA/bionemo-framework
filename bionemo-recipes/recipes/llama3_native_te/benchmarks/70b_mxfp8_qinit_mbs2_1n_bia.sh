...
# ============================================================================
# Lingua 70B MXFP8 WITH quantized init — MBS=2 benchmark (1 node, bia B300)
# CP=2, dp_size=4. All layers FP8 with quantized init.
...
echo "========================================="
echo "Lingua 70B MXFP8 Quantized Init — MBS=2 Benchmark (1 node, bia B300)"
