...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-mp.fs-qinit-hpiv
...
# ============================================================================
# Memory Profiler: TE fully_shard example — MXFP8 qinit (HPIV=true)
...
export EXP_NAME="${EXP_NAME:-mp_fully_shard_qinit_hpiv}"
RESULTS_DIR="${SCRATCH}/results/${EXP_NAME}"
SNAP_DIR="${SCRATCH}/memory_snapshots/fully_shard_qinit_hpiv"
...
echo "========================================="
echo "Memory Profiler: fully_shard — qinit (HPIV=true)"
...
torchrun --nproc-per-node 2 $SCRIPT --snapshot-dir /workspace/snapshots

echo "========================================="
echo "Done! Snapshot: /workspace/snapshots/qinit_hpiv_T/memory_snapshot.pickle"
echo "========================================="
OUTER_EOF
