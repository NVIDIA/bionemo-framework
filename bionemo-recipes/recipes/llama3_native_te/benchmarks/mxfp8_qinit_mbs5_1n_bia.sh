...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.mxfp8-mbs5
...
export EXP_NAME="${EXP_NAME:-lingua_7b_mxfp8_qinit_mbs5_1n_bia}"
...
echo "========================================="
echo "Lingua 7B MXFP8 Quantized Init — MBS=5 Benchmark (1 node, bia B300)"
