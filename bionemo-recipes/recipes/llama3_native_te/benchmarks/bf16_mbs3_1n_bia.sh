...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.bf16-mbs3
...
# ============================================================================
# Lingua 7B BF16 — MBS=3 benchmark (1 node, bia B300)
...
export EXP_NAME="${EXP_NAME:-lingua_7b_bf16_mbs3_1n_bia}"
...
echo "========================================="
echo "Lingua 7B BF16 — MBS=3 Benchmark (1 node, bia B300)"
