...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-mp.fs-bf16
...
# ============================================================================
# Memory Profiler: TE fully_shard example — BF16 baseline (no qinit)
...
export EXP_NAME="${EXP_NAME:-mp_fully_shard_bf16}"
RESULTS_DIR="${SCRATCH}/results/${EXP_NAME}"
SNAP_DIR="${SCRATCH}/memory_snapshots/fully_shard_bf16"
...
echo "========================================="
echo "Memory Profiler: fully_shard — BF16 baseline"
...
torchrun --nproc-per-node 2 $SCRIPT --no-qinit --snapshot-dir /workspace/snapshots

echo "========================================="
echo "Done! Snapshot: /workspace/snapshots/bf16/memory_snapshot.pickle"
echo "========================================="
OUTER_EOF
