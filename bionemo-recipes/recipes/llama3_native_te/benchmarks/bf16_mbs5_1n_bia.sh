...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.bf16-mbs5
...
# ============================================================================
# Lingua 7B BF16 — MBS=5 benchmark (1 node, bia B300)
# Expected to OOM — compare OOM size against MXFP8 qinit MBS=5.
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-lingua_7b_bf16_mbs5_1n_bia}"
...
echo "========================================="
echo "Lingua 7B BF16 — MBS=5 Benchmark (1 node, bia B300)"
