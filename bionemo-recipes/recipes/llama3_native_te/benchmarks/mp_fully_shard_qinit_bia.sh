...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-mp.fs-qinit
...
# ============================================================================
# Memory Profiler: TE fully_shard example — MXFP8 qinit (HPIV=false)
...
export EXP_NAME="${EXP_NAME:-mp_fully_shard_qinit}"
RESULTS_DIR="${SCRATCH}/results/${EXP_NAME}"
SNAP_DIR="${SCRATCH}/memory_snapshots/fully_shard_qinit"
...
echo "========================================="
echo "Memory Profiler: fully_shard — qinit (HPIV=false)"
...
torchrun --nproc-per-node 2 $SCRIPT --no-hpiv --snapshot-dir /workspace/snapshots

echo "========================================="
echo "Done! Snapshot: /workspace/snapshots/qinit_hpiv_F/memory_snapshot.pickle"
echo "========================================="
OUTER_EOF
