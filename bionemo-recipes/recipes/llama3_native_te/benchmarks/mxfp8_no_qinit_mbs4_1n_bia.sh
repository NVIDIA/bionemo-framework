...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.mxfp8-noqi-mbs4
...
# ============================================================================
# Lingua 7B MXFP8 WITHOUT quantized init — MBS=4 benchmark (1 node, bia B300)
# Compare against qinit to see if qinit enables larger MBS.
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-lingua_7b_mxfp8_no_qinit_mbs4_1n_bia}"
...
echo "========================================="
echo "Lingua 7B MXFP8 NO Quantized Init — MBS=4 Benchmark (1 node, bia B300)"
...
python train_fsdp2.py --config-name L2_lingua_7b_mxfp8 \
