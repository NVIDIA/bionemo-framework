...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.mxfp8-qinit-nohpiv-mbs4
...
# ============================================================================
# Lingua 7B MXFP8 quantized init (preserve_high_precision_init_val=false)
# MBS=4 benchmark (1 node, bia B300)
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-lingua_7b_mxfp8_qinit_no_hpiv_mbs4_1n_bia}"
...
echo "========================================="
echo "Lingua 7B MXFP8 Quantized Init (no HPIV) — MBS=4 Benchmark (1 node, bia B300)"
