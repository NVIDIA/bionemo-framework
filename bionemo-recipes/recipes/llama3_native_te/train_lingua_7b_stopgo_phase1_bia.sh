...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.stopgo-phase1
...
# ============================================================================
# Stop-and-Go Test: PHASE 1 (train 500 steps, save checkpoint)
# After this completes, submit train_lingua_7b_stopgo_phase2_bia.sh
# ============================================================================
...
echo "========================================="
echo "Stop-and-Go Test: PHASE 1 (500 steps)"
...
echo "========================================="
echo "Phase 1 complete! Checkpoint saved at step 500."
echo "Now submit train_lingua_7b_stopgo_phase2_bia.sh"
echo "========================================="
EOF

echo "Launching: ${EXP_NAME} (phase 1)"
srun \
