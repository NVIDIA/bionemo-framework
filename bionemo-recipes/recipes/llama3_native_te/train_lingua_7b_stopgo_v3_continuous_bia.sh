...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.stopgo-v3-continuous
...
# ============================================================================
# Stop-and-Go Diagnostic v3: CONTINUOUS baseline
# Resume from step 500 checkpoint, run continuously to step 3500.
# Compare with the stop-and-go run (train_lingua_7b_stopgo_v3_resume_bia.sh).
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-stopgo_v3_continuous}"
...
echo "========================================="
echo "Stop-and-Go v3: CONTINUOUS (500 -> 3500)"
