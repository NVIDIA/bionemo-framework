...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.mxfp8-fl1-qinit-bia
...
export EXP_NAME="${EXP_NAME:-lingua_7b_mxfp8_fl1_qinit_8n_bia}"
...
echo "========================================="
echo "Lingua 7B MXFP8 FL1 + Quantized Init (8 nodes, bia B300)"
echo "Job ID: ${SLURM_JOB_ID}"
echo "Nodes: ${SLURM_JOB_NUM_NODES}"
echo "========================================="

# TE setup — PYTHONPATH only, TE rebuilt for B300 (103a)
