...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.bf16
...
export EXP_NAME="${EXP_NAME:-lingua_7b_bf16_8n_ptyche}"
...
echo "========================================="
echo "Starting Lingua 7B BF16 Training (8 nodes, ptyche ARM)"
