...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua70b.fp8-thd-bia
...
export EXP_NAME="${EXP_NAME:-lingua_70b_mxfp8_thd_bench_4n_cp2_bia}"
...
echo "========================================="
echo "Starting Lingua 70B MXFP8 THD Benchmark (4 nodes, CP=2, bia B300, GBS=16)"
