...
export EXP_NAME="${EXP_NAME:-lingua_70b_mxfp8_bshd_bench_4n_cp4_prenyx}"
...
echo "========================================="
echo "Starting Lingua 70B MXFP8 Benchmark (4 nodes, CP=4, prenyx, GBS=8)"
...
python train_fsdp2_cp.py --config-name L2_lingua_70b_mxfp8_cp4 \
