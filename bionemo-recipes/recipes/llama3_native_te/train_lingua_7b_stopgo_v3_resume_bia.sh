...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua7b.stopgo-v3-resume
...
# ============================================================================
# Stop-and-Go Diagnostic v3: STOP-AND-GO (checkpoint every 500 steps)
# Resume from step 500 checkpoint, stop/restart every 500 steps to step 3500.
# Compare with the continuous run (train_lingua_7b_stopgo_v3_continuous_bia.sh).
#
# USAGE: Submit 6 times sequentially (wait for each to finish before next):
#   STOP_AT_STEP=1001 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 500 -> 1000
#   STOP_AT_STEP=1501 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 1000 -> 1500
#   STOP_AT_STEP=2001 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 1500 -> 2000
#   STOP_AT_STEP=2501 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 2000 -> 2500
#   STOP_AT_STEP=3001 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 2500 -> 3000
#   STOP_AT_STEP=3501 sbatch train_lingua_7b_stopgo_v3_resume_bia.sh   # 3000 -> 3500
# ============================================================================
...
export EXP_NAME="${EXP_NAME:-stopgo_v3_resume}"
...
echo "========================================="
echo "Stop-and-Go v3: RESUME (-> step ${STOP_AT_STEP})"
