...
#SBATCH --mem=0
#SBATCH --job-name=healthcareeng_bionemo-lingua70b.bf16-thd-bench
...
export EXP_NAME="${EXP_NAME:-lingua_70b_bf16_thd_bench_4n_prenyx_v2}"
...
echo "========================================="
echo "Starting Lingua 70B BF16 THD Benchmark (4 nodes, prenyx, GBS=16)"
