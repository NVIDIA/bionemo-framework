...
#SBATCH --mem=0
#SBATCH --job-name=lingua-7b-bf16-stateful
...
export EXP_NAME="${EXP_NAME:-lingua_7b_bf16_stateful_4n_prenyx}"
...
echo "========================================="
echo "Starting Lingua 7B BF16 Training w/ Stateful DL (4 nodes, prenyx)"
