...
"""Shared test utilities for distributed (EP/FSDP) tests in the opengenome2_mixtral_native_te recipe."""
...
def create_small_mixtral_config(**overrides) -> NVMixtralConfig:
    """Create a small og2-style Mixtral config suitable for testing."""
    defaults = {
        "hidden_size": 128,
