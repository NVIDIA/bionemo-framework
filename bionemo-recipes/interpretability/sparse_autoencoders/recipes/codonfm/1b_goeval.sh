...
# CodonFM Encodon-1B: Full Extract + Train + Gene-Level GSEA Enrichment Pipeline
...
echo ""
echo "============================================================"
echo "STEP 5: Gene-level GSEA enrichment evaluation"
echo "============================================================"
...
python scripts/eval_gene_enrichment.py \
    ...
    --n-workers 8 \
    --fdr-threshold 0.05 \
    --output-dir ${OUTPUT_DIR}/gene_enrichment \
    --dashboard-dir ${OUTPUT_DIR}/dashboard

echo ""
echo "============================================================"
echo "DONE"
echo "  Dashboard:        ${OUTPUT_DIR}/dashboard"
echo "  GSEA results:     ${OUTPUT_DIR}/gene_enrichment"
echo "============================================================"
