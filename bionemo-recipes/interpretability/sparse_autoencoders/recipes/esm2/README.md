...
Train and analyze sparse autoencoders on [ESM2](https://github.com/facebookresearch/esm) protein language models. The pipeline extracts residual stream activations from protein sequences, trains a TopK SAE, evaluates reconstruction quality and biological alignment (F1 against Swiss-Prot annotations), and generates an interactive feature dashboard.
...
save_activations_parquet(codes=codes, protein_ids=ids, output_path="activations.parquet")
