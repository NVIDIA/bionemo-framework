...
def verify_model_parameters_initialized_correctly(
    ...
    for name, module in model.named_modules():
        ...
        if isinstance(module, torch.nn.Embedding):
            ...
            assert module.weight is model.model.embeddings.word_embeddings.weight, (
                "Decoder weight tying has been broken"
            )
...
if __name__ == "__main__":
    ...
    for layer in model_meta_device.model.encoder.layers:
        fully_shard(layer)
    ...
    for layer in model_normal_init.model.encoder.layers:
        fully_shard(layer)
