...
def test_padding_unpadding_operations():
    ...
    assert original_embeddings.shape == converted_embeddings.shape, f"Embedding shapes don't match: {original_embeddings.shape} vs {converted_embeddings.shape}"
    ...
    assert original_decoder.shape == converted_decoder.shape, f"Decoder shapes don't match: {original_decoder.shape} vs {converted_decoder.shape}"
    ...
    assert original_bias.shape == converted_bias.shape, f"Bias shapes don't match: {original_bias.shape} vs {converted_bias.shape}"
