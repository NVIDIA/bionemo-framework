...
def test_thd_backwards_passes_match(te_model_checkpoint, input_data, input_data_thd, attn_impl):
    ...
    thd_word_embeddings_grad = thd_grads.pop("model.embeddings.word_embeddings.weight")
    bshd_word_embeddings_grad = bshd_grads.pop("model.embeddings.word_embeddings.weight")
    torch.testing.assert_close(
        thd_grads,
        bshd_grads,
