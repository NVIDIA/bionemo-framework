...
**Output Type(s):** Vector (Dense Embedding Predictions) <br>
**Output Format:** NumPy <br>
**Output Parameters:** Embedding dimension (1D vector) <br>
...
- **Self-Reported Ethnicity:**
  - Approximately 12M cells are not annotated; 9M are annotated as "European." 0.5M are annotated as "Han Chinese," followed by "African American."
- **Age Bias:**
...
![Training and Validation Loss Over Time](../assets/old_images/sc_fm/geneformer-10m-240530-val-train-loss.png)
...
!!! note "Training curves from BioNeMo1"
    ...
    ![Training Curve Comparison Between BioNeMo1 and BioNeMo2](../assets/images/geneformer/loss_curve_new_v_old_geneformer_64_node_10M.png)
...
![Training and Validation Loss Over Time](../assets/old_images/sc_fm/geneformer-106m-240530-val-train-loss.png)
...
![Validation Loss Comparison Between 10M and 106M Models](../assets/old_images/sc_fm/geneformer-240530-val-comparison.png)
...
!!! bug "Baseline Geneformer was recently updated on HuggingFace making loss comparisons challenging."
    ...
    In a future release we will make checkpoint conversion scripts available so that the public model can be run
...
![F1-Score Comparison Across Models](../assets/images/geneformer/F1-score-models.png)
![Average Accuracy Comparison Across Models](../assets/images/geneformer/average-accuracy-models.png)
...
![TFLOPS per A100 GPU for Different Model Sizes](../assets/images/geneformer/model_tflops_per_gpu_chart_geneformer.png)
