...
BioNeMo 2 provides two entrypoints for models with both argparse and pydantic. Both are documented in the `Models` section below.
...
For NVIDIA internal employees with new data etc:
...
> ⚠️ **Warning:** This setup does NO configuration of Weights and Biases. Edit your config YAML and populate it with your Weights and Biases details.
