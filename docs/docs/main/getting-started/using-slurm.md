...
&&  \
cd /workspace/bionemo2/bionemo-recipes/recipes/evo2_megatron \
&& train_evo2 \
    -d /workspace/bionemo2/bionemo-recipes/recipes/evo2_megatron/examples/configs/full_pretrain_shortphase_config.yaml \
