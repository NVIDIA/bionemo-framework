...
const BeamSearch2 = ({ data, width = 1050, height = 150 }) => {
  ...
  const { root, links } = useMemo(() => {
    ...
    for (
      ...
      if (nodesByDepth[depth]) {
        ...
        const levelSpacing = depth % 2 === 0 ? 80 * SHRINK : 50 * SHRINK; // More space after hypothesis nodes
